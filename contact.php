...
<html lang="en">
  ...
  <?php include 'partials/_nav.php';?>
      ...
      <div class="contact2" style="background-image:url(img/aestehtic.jpg);height: 400px;" id="contact">
        <div class="container">
              ...
              <div class="card card-shadow border-0 mb-4">
                <div class="row">
                    ...
                    <div class="contact-box p-4">
                      ...
                      <form action="partials/_manageContactUs.php" method="POST">
                        <div class="row">
                          ...
                          <div class="col-lg-12">
                            <div class="form-group  mt-3">
                                <textarea class="form-control" id="message" name="message" rows="2" required minlength="6" placeholder="Type your message here"></textarea>
                            </div>
                          </div>
                          <?php if($loggedin){ ?>
                            <div class="col-lg-12">
                  ...
                  <?php
                    ...
                    echo '<div class="col-lg-4 bg-image" style="background-image:url(img/ctc1.jpg)">
                          <div class="detail-box p-4">
                            <h4 class="text-red font-weight-heavy mb-3">ADDRESS</h4>
                            <p class="text-white op-7">' .$address. '</p>
                            <h4 class="text-black font-weight-light mb-3"><strong>CALL US</strong></h4>
                            ...
                            <div class="round-social light">
                              ...
                              <a href="https://www.youtube.com/watch?v=2f2Kt8e6htw" class="text-decoration-none text-white border border-white rounded-circle" target="_blank"><i class="fab fa-youtube"></i></a>
                            </div>
                          </div>
                        </div>';
                  ?>
