...
<body>
    ...
    <div class="container my-4" id="cont">
        ...
        ?>
        <script> document.getElementById("title").innerHTML = "<?php echo $BagName; ?>"; </script> 
        <?php
        echo  '<div class="col-md-4">
                <img src="img/pizza-'.$BagID. '.png" width="249px" height="262px">
            </div>
            <div class="col-md-8 my-4">
                <h3>' . $BagName . '</h3>
                <h5 style="color: #ff0000">RM. '.$BagPrice. '/-</h5>
                <p class="mb-0">' .$BagDesc .'</p>';
                ...
                <div class="mx-4">
                    <a href="viewBagList.php?catid=' . $BagCategorieId . '" class="active text-dark">
